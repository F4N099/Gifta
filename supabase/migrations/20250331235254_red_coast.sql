/*
  # Fix share token generation in shared_gifts table

  1. Changes
    - Drop existing table if exists
    - Create shared_gifts table with proper share_token handling
    - Add RLS policies for sharing
    - Add function to generate unique share tokens
*/
